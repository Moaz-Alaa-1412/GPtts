...
//import 'package:testapp/models/data.dart' as pro;
import 'package:testapp/widgets/project_card_tile.dart' as pro;
          ...
          child: Padding(
            ...
            child: ListTile(
              leading: Container(
                child: Center(
                  child: Text(
                    pro.title[rng.nextInt(3)].split(" ")[0][0],
                    style: TextStyle(
                        color: Colors.white,
